...
def main():
    ...
    model = TextCNN(len(vocab), embed_dim=128, num_classes=3, pad_idx=vocab['<PAD>']).to(device)
    ...
    plt.grid(axis='y')
    plt.savefig('final_evaluation_metrics_TextCNN_3class.png')
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('TextCNN_loss_curve_3class.png')
    plt.close()
    ...
    plt.ylabel('True')
    plt.savefig('TextCNN_confusion_matrix_3class.png')
    plt.close()
...
def generate_response(sentiment_label):
    responses = {
        "Positive": "Thank you for your positive review! We're thrilled you had a great experience.",
        "Neutral": "Thanks for your feedback. We'll take it into consideration to improve our service.",
        "Negative": "We're sorry to hear about your experience. We appreciate your honest feedback and will work to do better."
    }
    return responses.get(sentiment_label, "Thank you for your review.")
